...
2. **The YAML 4D DAG:** Axi ships with a native, built-in version control system (DVCS). Instead of Git, Axi uses a Directed Acyclic Graph (DAG) serialized in **YAML** (Token-Oriented Object Notation). YAML is a highly-compressed, AST-friendly format designed specifically to reduce LLM context windows.
...
pub fn main(args: string[]) {
    ...
    // 3. Commit the metadata directly to your YAML DAG
...
Axi comes with a globally bound CLI to manage your projects and your YAML DAG.
...
# Snapshot your uncommitted AST deltas to the YAML ledger
axi wrap
```
