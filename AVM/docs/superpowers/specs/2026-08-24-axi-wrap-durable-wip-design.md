...
Revision note: `lang\Axi` is the canonical Axos language tree.
...
- The canonical Axos language source tree is `lang\Axi`.
...
The canonical Axos language source tree is `lang\Axi`. The former
