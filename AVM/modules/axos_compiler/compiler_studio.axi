...
// Dynamic Source to Target Language semantic routing
HOW TO transpile(source_filepath, source_language, target_language, output_filepath):
    ...
    PUT "You are the Axi Universal Compiler. Semantically transpile the following " IN base_prompt
    PUT core.str.concat(base_prompt, source_language) IN p1
    PUT core.str.concat(p1, " source code into pure ") IN p2
    PUT core.str.concat(p2, target_language) IN lang_prompt
