...
Axiom (`.axi`) is a high-performance, strictly-typed systems programming language designed from the ground up to replace Python and C++ in AI orchestration, tensor math, and bare-metal hardware control.
